      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          ...
          */
          ...
          //Fitting the waypoint into a line 
          auto coeffs = polyfit(waypoints_x, waypoints_y, 3);
          
          
          // cte is the difference between the line and the reference 
          double cte = polyeval(coeffs, 0);
          
          // the change in orientation is dependant only on coeffs[1]
          double epsi = -atan(coeffs[1]);

          // constant for the given car
